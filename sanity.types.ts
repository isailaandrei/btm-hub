...
// Query: *[_type == "film" && slug.current == $slug][0] {    _id, title, slug, tagline, description, heroImage, thumbnailImage, videoEmbed,    gallery, credits, releaseYear, duration, status, featured, sortOrder,    locations, subjects, formats, skills, displayTags  }
