    ...
    <form action={formAction} className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <input
          ...
          className="rounded-lg border border-border bg-card px-4 py-2.5 text-sm text-foreground placeholder:text-muted-foreground focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
        />
        {state.errors?.title && (
