...
export interface FieldRegistryEntry {
  key: string;
  label: string;
  type: "select" | "multiselect" | "rating" | "date" | "text";
...
export const FIELD_REGISTRY: FieldRegistryEntry[] = [
  ...
  // ---- Text fields (display-only, no curated filter options) ----
  {
    key: "online_links",
    label: "Social Links",
    type: "text",
  ...
  {
    key: "filming_equipment",
    label: "Filming Equipment",
    type: "text",
    options: [],
    programs: ["filmmaking", "internship"],
    curated: false,
  },
  {
  ...
  {
    key: "freediving_equipment",
    label: "Freediving Equipment",
    type: "text",
    options: [],
    programs: ["freediving"],
    curated: false,
  ...
  {
    key: "inspiration_to_apply",
    label: "Inspiration to Apply",
    type: "text",
    options: [],
    programs: ["filmmaking", "photography", "freediving", "internship"],
    curated: false,
  ...
  {
    key: "comfortable_max_depth",
    label: "Comfortable Max Depth",
    type: "text",
    options: [],
    programs: ["freediving"],
    curated: false,
  ...
  {
    key: "accommodation_ties",
    label: "Azores Accommodation / Ties",
    type: "text",
    options: [],
    programs: ["internship"],
    curated: false,
  ...
  {
    key: "internship_hopes",
    label: "Internship Hopes",
    type: "text",
    options: [],
    programs: ["internship"],
    curated: false,
  ...
  {
    key: "candidacy_reason",
    label: "Why Good Candidate",
    type: "text",
    options: [],
    programs: ["internship"],
    curated: false,
