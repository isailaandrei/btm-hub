...
const QUESTION_FORM_PATH =
  "src/app/(dashboard)/admin/admin-ai/question-form.tsx";
const MESSAGE_LIST_PATH =
  "src/app/(dashboard)/admin/admin-ai/message-list.tsx";
const PANEL_PATH = "src/app/(dashboard)/admin/admin-ai/panel.tsx";
