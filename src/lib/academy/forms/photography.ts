...
// ---------------------------------------------------------------------------
// Photography application form — mirrors partner A's live Google Form.
// ---------------------------------------------------------------------------
...
const equipmentFields: FieldDefinition[] = [
  { type: "multiselect", name: "equipment_owned", label: "Current equipment owned", options: PHOTOGRAPHY_EQUIPMENT, required: false, allowOther: true },
  { type: "text", multiline: true, name: "photography_equipment", label: "List your underwater photography equipment", placeholder: "Camera body, lenses, housing, lights, editing software...", required: true },
...
const skillsFields: FieldDefinition[] = [
  { type: "select", name: "years_experience", label: "Years of experience in underwater photography", options: YEARS_EXPERIENCE, required: true },
  ...
  { type: "rating", name: "skill_drone", label: "Drone photography" },
...
const creativeProfileFields: FieldDefinition[] = [
  { type: "multiselect", name: "content_created", label: "What type of underwater content have you created so far?", options: PHOTOGRAPHY_CONTENT_CREATED, required: true, allowOther: true },
  ...
  { type: "select", name: "involvement_level", label: "Current involvement in underwater photography", options: INVOLVEMENT_LEVELS, required: true, allowOther: true },
  ...
  { type: "select", name: "income_from_photography", label: "Do you currently earn income from underwater photography?", options: MEDIA_INCOME, required: true },
];
...
const goalsFields: FieldDefinition[] = [
  { type: "select", name: "primary_goal", label: "What is your primary goal with BTM Academy?", options: PHOTOGRAPHY_GOALS, required: true },
  { type: "select", name: "secondary_goal", label: "What is your secondary goal with BTM Academy?", options: PHOTOGRAPHY_GOALS, required: true },
  { type: "multiselect", name: "learning_aspects", label: "What aspects are you most interested in learning?", options: PHOTOGRAPHY_LEARNING_ASPECTS, required: true },
  { type: "multiselect", name: "content_to_create", label: "What type of content would you like to create?", options: PHOTOGRAPHY_CONTENT_TO_CREATE, required: true },
...
const openQuestionsFields: FieldDefinition[] = [
  { type: "text", multiline: true, name: "ultimate_vision", label: "Please describe your ultimate vision for your underwater photography journey", minLength: 10, required: true },
